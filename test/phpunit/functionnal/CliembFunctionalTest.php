...
/**
 * \file    test/phpunit/CliembFunctionalTest.php
 * \ingroup cliemb
 ...
 * @package Testcliemb
 */
class CliembFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/cliemb/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('cliemb/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/cliemb/admin/about.php');
		$this->authenticate();
		return $this->assertContains('cliemb/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('cliembwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCliemb_CliembTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCliemb_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
